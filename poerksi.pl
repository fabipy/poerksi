...
match([wer,ist,dr,pörksi],['Habe ich das nicht schon erwähnt? Ich bin Dr. Pörksi und helfe Ihnen bei Ihren Fragen gerne weiter.']) :- not(name('Gast')).
...
match([in,welchem,gebäude,ist,raum,X],['Dazu gehen sie einfachHallo ich bin Dr. Pörksi. Gerne dürfen Sie mir so viele Fragen stellen, wie Sie nur möchten und ich werde versuchen diese zu beantworten. Denn für Fragen hinsichtlich der Universität oder der zu belgenden Vorlesungen stehe ich Ihnen gerne zur Seite. Aber auch allgemeinen Anliegen bezüglich des Studienalltags nehme ich mich gerne an.
User:       hallo
Dr.Pörksi:  Hallo lieber Nutzer.Es freut mich jemanden gegenüber zu haben. Und da ich mich am Liebsten mit Kommunikation beschäftige können Sie mir ja gleich mal eine Frage stellen.
User:       was unterrichten sie
Dr.Pörksi:
User:       wer sind sie eigentlich
Dr.Pörksi:
User:       wer sind sie
Dr.Pörksi:
User:       wer bist du
Dr.Pörksi: Ich bin eine künstliche Intelligenz, die ratlosen Studenten weiterhelfen soll. Mich gibt es aber noch gar nicht so lange hier am Institut.
Entworfen wurde ich von drei Studenten der Medienwissenschaft. Ihnen verdanke ich meine Existenz, insofern ich überhaupt eine Existenz habe...?
Aber genug philosophiert, wer Sind Sie denn?
Wie ist denn Ihr Name?
User:       blah
Es ist schön Sie kennenzulernen. Haben Sie denn auch Fragen an mich mitgebracht Blah oder irgendein anderes Anliegen?
User:       welche professoren gibt es
Dr.Pörksi: Folgende Professoren lehren in Tübingen am Institut für Medienwissenschaft:
Herr Prof. Dr. Jürg,Häusermann
Herr Prof. Dr. Claus Kleber
Frau Prof. Dr. Susanne Marschall
Herr Prof. Dr. Klaus Sachs-Hombach
Herr Prof. Dr. Bernhard Pörksen
Frau Prof. Dr. Tanja,Thomas
Herr Prof. Dr. Guido Zurstiege
Ich hoffe ich konnte Ihnen weiterhelfen.
User:       wie lautet die email adresse von bernhard pörksen
Dr.Pörksi:
User:       wie lautet die email adresse von pörksen
Dr.Pörksi:
User:       email von pörksen
Dr.Pörksi: Die Email von Herr Prof. Dr. Bernhard Pörksen lautet bernhard.poerksen@uni-tuebingen.de
User:       telefonnummer von tanja thomas
Dr.Pörksi: Die Telefonnumer von Frau Prof. Dr. Tanja Thomas lautet 07071 29-76816
User:       wer ist claus kleber
Dr.Pörksi: Name: Herr Prof. Dr. Claus Kleber
Raum: 209
Email: claus.kleber@uni-tuebingen.de
Telefon: keine Angabe
Bereich/Aufgabe: Jouranlistische Themen und Berufspraxis in Film und Fernsehen
Was wollen Sie noch wissen?
User:       wie kann man das gespräch beenden
Dr.Pörksi: Du beendest mich durch die Eingabe: "tschüss"
User:       tschüss
Dr.Pörksi: Ich hoffe ich konnte dir helfen. Viel Spaß beim studieren! Und du weißt ja, falls du Fragen hast, wo man mich findet. in das Stockwerk Nr',Stock,'und schon dürften Sie ihn gefunden haben. Ich hoffe ich konnte Ihnen helfen.']) :- atom_number(X,Num),integer(Num),atom_chars(X,Chars),Chars = [Stock|_], Num < 500.
...
match([macht,man,in],['Nicht so voreilig, das wirst du schon noch erleben.']).
%Spiel
match([spielen],[ ]) :- write("Ok, in alter Nerd-Manier möchte ich eine Runde Schere, Stein, Papier,Echse, Spock mit dir spielen. Um dieses Spiel zu beginnen wählen Sie bitte eins der folgenden Objekte: Stein, Papier, Schere, Echse, Spock. Und beenden Sie Ihre Eingabe mit einem Punkt."), nl, spielen.
...
Wesen wie Sie das Abitur geschafft hat.']):-beleid(Input,[]).
