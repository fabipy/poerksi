...
match([wo,kann,_,essen,gehen],['Es ist wichtig, dass Sie ihr Gehirn fit halten und dann ist es super, wenn Sie schon nach Essensm�glichkeiten fragen. Hier finden Sie gen�gend Nervennahrung',Y ]):-bagof(X,essen(X),Y).
